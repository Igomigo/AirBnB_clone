#!/usr/bin/python3
"""Module that contains the unittest cases for console.py.
Here are the tested classes:
...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    """Unittests to test prompt command(hbnb) of the command interpreter"""
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for the 'help' docstring of the HBNB command interpreter."""
